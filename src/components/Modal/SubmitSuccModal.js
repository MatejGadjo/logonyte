...
const SubmitSuccModal = ({ closeModal }) => {
        ...
        <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none pl-16">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    {/*content*/}
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[14rem] sm:w-[15rem] md:w-[25rem] lg:w-full bg-gray-800 outline-none focus:outline-none">
                        {/*header*/}
                        ...
                        <div className="relative p-6 flex-auto">
                            <p className="my-4 text-slate-300 text-lg">
                                Your logo will be uploaded on the catalog page within a week. An email will also be
                                sent out when the logo is uploaded. Thank you!
                            </p>
                        </div>
                        {/*footer*/}
...
export default SubmitSuccModal;
